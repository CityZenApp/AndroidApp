    ...
    public static void setupPlaceIcon(Context context, String type, ImageView categoryImageView) {
        switch (type) {
            ...
            case "administrative":
                ...
                break;
            case "mall":
                setupItemIcon(context, R.drawable.ic_local_city, R.color.category_mall, categoryImageView);
                break;
            case "residential":
                setupItemIcon(context, R.drawable.ic_local_city, R.color.category_building, categoryImageView);
                break;
            ...
            case "university":
                ...
                break;
            case "hotel":
                setupItemIcon(context, R.drawable.ic_home_white, R.color.category_hotel, categoryImageView);
                break;
            case "hostel":
                setupItemIcon(context, R.drawable.ic_home_white, R.color.category_home, categoryImageView);
                break;
            case "guest_house":
                setupItemIcon(context, R.drawable.ic_home_white, R.color.category_home, categoryImageView);
                break;
            case "attraction":
                setupItemIcon(context, R.drawable.ic_nature_people_white, R.color.category_attraction, categoryImageView);
                break;
            case "pedestrian":
                setupItemIcon(context, R.drawable.ic_nature_people_white, R.color.category_attraction, categoryImageView);
                break;
            ...
            case "atm":
                ...
                break;
            case "taxi":
                setupItemIcon(context, R.drawable.ic_local_transit_station_white, R.color.category_transit, categoryImageView);
                break;
            case "bus_stop":
                setupItemIcon(context, R.drawable.ic_local_transit_station_white, R.color.category_transit, categoryImageView);
                break;
            ...
            case "transportation":
                ...
                break;
            case "fuel":
                setupItemIcon(context, R.drawable.ic_local_gas_station_white, R.color.category_gas, categoryImageView);
                break;
            case "hospital":
                setupItemIcon(context, R.drawable.ic_local_doctor_white, R.color.category_health, categoryImageView);
                break;
            case "pharmacy":
                setupItemIcon(context, R.drawable.ic_local_pharmacy_white, R.color.category_health, categoryImageView);
                break;
            case "mobile_phone":
                setupItemIcon(context, R.drawable.ic_phonelink_setup_white, R.color.category_communication, categoryImageView);
                break;
            case "mobile_shop":
                setupItemIcon(context, R.drawable.ic_phonelink_setup_white, R.color.category_communication, categoryImageView);
                break;
